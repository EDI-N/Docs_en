...
versionwarning_messages = {
    "latest": (
        "<img src='https://wiki.edin.ua/en/latest/_static/Trident_b.png' alt='alternatetext' style='height:45px;'><strong><a href='https://bank.gov.ua/ua/news/all/natsionalniy-bank-vidkriv-spetsrahunok-dlya-zboru-koshtiv-na-potrebi-armiyi'>Допомогти ЗСУ</a></strong>"
    ),
}
