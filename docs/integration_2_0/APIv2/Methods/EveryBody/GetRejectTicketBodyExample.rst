########################################################################################################
**Response example ticket creation of "Notice of refusal to sign the document"**
########################################################################################################
...
**Body response example (json_base64):**
...
**Body response example (xml_base64):**
